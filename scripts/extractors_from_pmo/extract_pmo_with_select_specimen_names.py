...
def parse_args_extract_pmo_with_select_specimen_names():
    ...
    parser.add_argument('--specimen_names', type=str, required=True, help='Can either comma separated specimen_names, or a plain text file where each line is a specimen_name')
