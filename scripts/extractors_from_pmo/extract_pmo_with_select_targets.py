...
def parse_args_extract_pmo_with_select_targets():
    ...
    parser.add_argument('--targets', type=str, required=True, help='Can either comma separated target_namess, or a plain text file where each line is a target_namess')
