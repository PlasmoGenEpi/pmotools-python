...
class TestMhapTableToJson(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.small_detected_dict = {"bioinformatics_run_name": 'run1', "experiment_samples": [{"experiment_sample_name": "sample1", "target_results": [{"mhaps_target_id": 0, "mhaps": [{"mhap_id": 0, "reads": 10}]}, {"mhaps_target_id": 1, "mhaps": [{"mhap_id": 0, "reads": 100}]}, {"mhaps_target_id": 2, "mhaps": [{"mhap_id": 0, "reads": 10}]}]},
                                                                                              {"experiment_sample_name": "sample2", "target_results": [{"mhaps_target_id": 0, "mhaps": [{"mhap_id": 0, "reads": 1}]}, {"mhaps_target_id": 1, "mhaps": [
                                                                                                  {"mhap_id": 0, "reads": 12}, {"mhap_id": 1, "reads": 53}]}, {"mhaps_target_id": 2, "mhaps": [{"mhap_id": 1, "reads": 73}]}]},
                                                                                              {"experiment_sample_name": "sample3", "target_results": [{"mhaps_target_id": 0, "mhaps": [
                                                                                                  {"mhap_id": 1, "reads": 76}]}, {"mhaps_target_id": 1, "mhaps": [{"mhap_id": 1, "reads": 6}]},]},
                                                                                              {"experiment_sample_name": "sample4", "target_results": [
                                                                                                  {"mhaps_target_id": 0, "mhaps": [{"mhap_id": 0, "reads": 297}]}]},
                                                                                              {"experiment_sample_name": "sample5", "target_results": [{"mhaps_target_id": 0, "mhaps": [{"mhap_id": 1, "reads": 123}, {
                                                                                                  "mhap_id": 2, "reads": 1}]}, {"mhaps_target_id": 2, "mhaps": [{"mhap_id": 0, "reads": 17}]}]},
                                                                                              ]}
        small_mhap_data = {'experiment_sample_name': ['sample1', 'sample1', 'sample1', 'sample2', 'sample2', 'sample2', 'sample2', 'sample3', 'sample3', 'sample4', 'sample5', 'sample5', 'sample5'],
    ...
    def test_build_detected_mhap_dict_with_umis(self):
        ...
        small_detected_dict_with_umis["experiment_samples"][0]["target_results"][0]["mhaps"][0]["umis"] = 10
        small_detected_dict_with_umis["experiment_samples"][0]["target_results"][1]["mhaps"][0]["umis"] = 100
        small_detected_dict_with_umis["experiment_samples"][0]["target_results"][2]["mhaps"][0]["umis"] = 10
        small_detected_dict_with_umis["experiment_samples"][1]["target_results"][0]["mhaps"][0]["umis"] = 1
        small_detected_dict_with_umis["experiment_samples"][1]["target_results"][1]["mhaps"][0]["umis"] = 12
        small_detected_dict_with_umis["experiment_samples"][1]["target_results"][1]["mhaps"][1]["umis"] = 53
        small_detected_dict_with_umis["experiment_samples"][1]["target_results"][2]["mhaps"][0]["umis"] = 73
        small_detected_dict_with_umis["experiment_samples"][2]["target_results"][0]["mhaps"][0]["umis"] = 76
        small_detected_dict_with_umis["experiment_samples"][2]["target_results"][1]["mhaps"][0]["umis"] = 6
        small_detected_dict_with_umis["experiment_samples"][3]["target_results"][0]["mhaps"][0]["umis"] = 297
        small_detected_dict_with_umis["experiment_samples"][4]["target_results"][0]["mhaps"][0]["umis"] = 123
        small_detected_dict_with_umis["experiment_samples"][4]["target_results"][0]["mhaps"][1]["umis"] = 1
        small_detected_dict_with_umis["experiment_samples"][4]["target_results"][1]["mhaps"][0]["umis"] = 17
    ...
    def test_build_detected_mhap_dict_with_additional_cols(self):
        ...
        small_detected_dict_with_ad_cols = copy.deepcopy(
            self.small_detected_dict)
        small_detected_dict_with_ad_cols["experiment_samples"][0]["target_results"][0]["mhaps"][0]["ad_col1"] = 'this1'
        small_detected_dict_with_ad_cols["experiment_samples"][0]["target_results"][1]["mhaps"][0]["ad_col1"] = 'this2'
        small_detected_dict_with_ad_cols["experiment_samples"][0]["target_results"][2]["mhaps"][0]["ad_col1"] = 'this3'
        small_detected_dict_with_ad_cols["experiment_samples"][1]["target_results"][0]["mhaps"][0]["ad_col1"] = 'this4'
        small_detected_dict_with_ad_cols["experiment_samples"][1]["target_results"][1]["mhaps"][0]["ad_col1"] = 'this1'
        small_detected_dict_with_ad_cols["experiment_samples"][1]["target_results"][1]["mhaps"][1]["ad_col1"] = 'this2'
        small_detected_dict_with_ad_cols["experiment_samples"][1]["target_results"][2]["mhaps"][0]["ad_col1"] = 'this3'
        small_detected_dict_with_ad_cols["experiment_samples"][2]["target_results"][0]["mhaps"][0]["ad_col1"] = 'this4'
        small_detected_dict_with_ad_cols["experiment_samples"][2]["target_results"][1]["mhaps"][0]["ad_col1"] = 'this1'
        small_detected_dict_with_ad_cols["experiment_samples"][3]["target_results"][0]["mhaps"][0]["ad_col1"] = 'this2'
        small_detected_dict_with_ad_cols["experiment_samples"][4]["target_results"][0]["mhaps"][0]["ad_col1"] = 'this3'
        small_detected_dict_with_ad_cols["experiment_samples"][4]["target_results"][0]["mhaps"][1]["ad_col1"] = 'this4'
        small_detected_dict_with_ad_cols["experiment_samples"][4]["target_results"][1]["mhaps"][0]["ad_col1"] = 'this4'
        small_detected_dict_with_ad_cols["experiment_samples"][0]["target_results"][1]["mhaps"][0]["ad_col2"] = 'that1'
        small_detected_dict_with_ad_cols["experiment_samples"][0]["target_results"][2]["mhaps"][0]["ad_col2"] = 'that2'
        small_detected_dict_with_ad_cols["experiment_samples"][1]["target_results"][1]["mhaps"][0]["ad_col2"] = 'that1'
        small_detected_dict_with_ad_cols["experiment_samples"][1]["target_results"][1]["mhaps"][1]["ad_col2"] = 'that2'
        small_detected_dict_with_ad_cols["experiment_samples"][2]["target_results"][0]["mhaps"][0]["ad_col2"] = 'that1'
        small_detected_dict_with_ad_cols["experiment_samples"][2]["target_results"][1]["mhaps"][0]["ad_col2"] = 'that2'
        small_detected_dict_with_ad_cols["experiment_samples"][4]["target_results"][0]["mhaps"][0]["ad_col2"] = 'that1'
        small_detected_dict_with_ad_cols["experiment_samples"][4]["target_results"][0]["mhaps"][1]["ad_col2"] = 'that2'
    ...
    def test_mhap_table_to_pmo_json(self, mock_create_detected_microhaplotype_dict, mock_create_representative_microhaplotype_dict):
        ...
        # TODO: change this to read in from json
        self.assertEqual(actual, '{\n    "representative_microhaplotypes": {\n        "targets": [\n            {\n                "target_name": "target1",\n                "microhaplotypes": [\n                    {\n                        "seq": "ACTG"\n                    },\n                    {\n                        "seq": "ATTG"\n                    },\n                    {\n                        "seq": "ATTA"\n                    }\n                ]\n            },\n            {\n                "target_name": "target2",\n                "microhaplotypes": [\n                    {\n                        "seq": "TTTT"\n                    },\n                    {\n                        "seq": "TTTA"\n                    }\n                ]\n            },\n            {\n                "target_name": "target3",\n                "microhaplotypes": [\n                    {\n                        "seq": "GGG"\n                    },\n                    {\n                        "seq": "AAG"\n                    }\n                ]\n            }\n        ]\n    },\n    "detected_microhaplotypes": {\n        "bioinformatics_run_name": "run1",\n        "experiment_samples": [\n            {\n                "experiment_sample_name": "sample1",\n                "target_results": [\n                    {\n                        "mhaps_target_id": 0,\n                        "mhaps": [\n                            {\n                                "mhap_id": 0,\n                                "reads": 10\n                            }\n                        ]\n                    },\n                    {\n                        "mhaps_target_id": 1,\n                        "mhaps": [\n                            {\n                                "mhap_id": 0,\n                                "reads": 100\n                            }\n                        ]\n                    },\n                    {\n                        "mhaps_target_id": 2,\n                        "mhaps": [\n                            {\n                                "mhap_id": 0,\n                                "reads": 10\n                            }\n                        ]\n                    }\n                ]\n            },\n            {\n                "experiment_sample_name": "sample2",\n                "target_results": [\n                    {\n                        "mhaps_target_id": 0,\n                        "mhaps": [\n                            {\n                                "mhap_id": 0,\n                                "reads": 1\n                            }\n                        ]\n                    },\n                    {\n                        "mhaps_target_id": 1,\n                        "mhaps": [\n                            {\n                                "mhap_id": 0,\n                                "reads": 12\n                            },\n                            {\n                                "mhap_id": 1,\n                                "reads": 53\n                            }\n                        ]\n                    },\n                    {\n                        "mhaps_target_id": 2,\n                        "mhaps": [\n                            {\n                                "mhap_id": 1,\n                                "reads": 73\n                            }\n                        ]\n                    }\n                ]\n            },\n            {\n                "experiment_sample_name": "sample3",\n                "target_results": [\n                    {\n                        "mhaps_target_id": 0,\n                        "mhaps": [\n                            {\n                                "mhap_id": 1,\n                                "reads": 76\n                            }\n                        ]\n                    },\n                    {\n                        "mhaps_target_id": 1,\n                        "mhaps": [\n                            {\n                                "mhap_id": 1,\n                                "reads": 6\n                            }\n                        ]\n                    }\n                ]\n            },\n            {\n                "experiment_sample_name": "sample4",\n                "target_results": [\n                    {\n                        "mhaps_target_id": 0,\n                        "mhaps": [\n                            {\n                                "mhap_id": 0,\n                                "reads": 297\n                            }\n                        ]\n                    }\n                ]\n            },\n            {\n                "experiment_sample_name": "sample5",\n                "target_results": [\n                    {\n                        "mhaps_target_id": 0,\n                        "mhaps": [\n                            {\n                                "mhap_id": 1,\n                                "reads": 123\n                            },\n                            {\n                                "mhap_id": 2,\n                                "reads": 1\n                            }\n                        ]\n                    },\n                    {\n                        "mhaps_target_id": 2,\n                        "mhaps": [\n                            {\n                                "mhap_id": 0,\n                                "reads": 17\n                            }\n                        ]\n                    }\n                ]\n            }\n        ]\n    }\n}')
