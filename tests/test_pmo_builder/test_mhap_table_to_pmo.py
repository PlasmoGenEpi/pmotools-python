...
class TestMhapTableToPMO(unittest.TestCase):
            ...
            "library_samples": [
                {
                    ...
                    "target_results": [
                        {"mhaps_target_id": 0, "mhaps": [{"mhap_id": 0, "reads": 10}]},
                        {"mhaps_target_id": 1, "mhaps": [{"mhap_id": 0, "reads": 100}]},
                        {"mhaps_target_id": 2, "mhaps": [{"mhap_id": 0, "reads": 10}]},
                    ],
                },
                {
                    "library_sample_name": "sample2",
                    "target_results": [
                        {"mhaps_target_id": 0, "mhaps": [{"mhap_id": 0, "reads": 1}]},
                        {
                            "mhaps_target_id": 1,
                            "mhaps": [
                                {"mhap_id": 0, "reads": 12},
                        ...
                        {"mhaps_target_id": 2, "mhaps": [{"mhap_id": 1, "reads": 73}]},
                    ],
                },
                {
                    "library_sample_name": "sample3",
                    "target_results": [
                        {"mhaps_target_id": 0, "mhaps": [{"mhap_id": 1, "reads": 76}]},
                        {"mhaps_target_id": 1, "mhaps": [{"mhap_id": 1, "reads": 6}]},
                    ],
                },
                {
                ...
                },
                {
                    ...
                    "target_results": [
                        ...
                        {"mhaps_target_id": 2, "mhaps": [{"mhap_id": 0, "reads": 17}]},
                    ],
                },
            ],
        }
    ...
    def test_get_target_id_in_representative_mhaps(self):
        expected_cols = self.small_mhap_table.columns.to_list() + ["mhaps_target_id"]
    ...
    def test_get_target_id_in_representative_mhaps_missing_target(self):
        ...
        self.assertEqual(
            "Missing target_name(s) in representative microhaplotype table: ['missing_target']",
    ...
    def test_get_mhap_index_in_representative_mhaps(self):
        ...
        self.assertListEqual(actual.columns.to_list(), expected_cols)
        self.assertListEqual(actual.mhap_id.to_list(), self.small_df_mhap_id_values)

    def test_get_mhap_index_in_representative_mhaps_missing_mhap(self):
        df_with_missing = self.small_mhap_table.replace("ATTG", "missing_seq1").copy()
    ...
    def test_build_detected_mhap_dict_with_umis(self):
        ...
        df_with_umis["umis"] = [10, 100, 10, 1, 12, 53, 73, 76, 6, 297, 123, 1, 17]
        # sample index, target index, mhap index
        small_detected_dict_with_umis = copy.deepcopy(self.small_detected_dict)
        small_detected_dict_with_umis["library_samples"][0]["target_results"][0][
            "mhaps"
        ][0]["umis"] = 10
        small_detected_dict_with_umis["library_samples"][0]["target_results"][1][
            "mhaps"
        ][0]["umis"] = 100
        small_detected_dict_with_umis["library_samples"][0]["target_results"][2][
            "mhaps"
        ][0]["umis"] = 10
        small_detected_dict_with_umis["library_samples"][1]["target_results"][0][
            "mhaps"
        ][0]["umis"] = 1
        small_detected_dict_with_umis["library_samples"][1]["target_results"][1][
            "mhaps"
        ][0]["umis"] = 12
        small_detected_dict_with_umis["library_samples"][1]["target_results"][1][
            "mhaps"
        ][1]["umis"] = 53
        small_detected_dict_with_umis["library_samples"][1]["target_results"][2][
            "mhaps"
        ][0]["umis"] = 73
        small_detected_dict_with_umis["library_samples"][2]["target_results"][0][
            "mhaps"
        ][0]["umis"] = 76
        small_detected_dict_with_umis["library_samples"][2]["target_results"][1][
            "mhaps"
        ][0]["umis"] = 6
        small_detected_dict_with_umis["library_samples"][3]["target_results"][0][
            "mhaps"
        ][0]["umis"] = 297
        small_detected_dict_with_umis["library_samples"][4]["target_results"][0][
            "mhaps"
        ][0]["umis"] = 123
        small_detected_dict_with_umis["library_samples"][4]["target_results"][0][
            "mhaps"
        ][1]["umis"] = 1
        small_detected_dict_with_umis["library_samples"][4]["target_results"][1][
            "mhaps"
        ][0]["umis"] = 17
    ...
    def test_build_detected_mhap_dict_with_additional_cols(self):
        ...
        small_detected_dict_with_ad_cols = copy.deepcopy(self.small_detected_dict)
        small_detected_dict_with_ad_cols["library_samples"][0]["target_results"][0][
            "mhaps"
        ][0]["ad_col1"] = "this1"
        small_detected_dict_with_ad_cols["library_samples"][0]["target_results"][1][
            "mhaps"
        ][0]["ad_col1"] = "this2"
        small_detected_dict_with_ad_cols["library_samples"][0]["target_results"][2][
            "mhaps"
        ][0]["ad_col1"] = "this3"
        small_detected_dict_with_ad_cols["library_samples"][1]["target_results"][0][
            "mhaps"
        ][0]["ad_col1"] = "this4"
        small_detected_dict_with_ad_cols["library_samples"][1]["target_results"][1][
            "mhaps"
        ][0]["ad_col1"] = "this1"
        small_detected_dict_with_ad_cols["library_samples"][1]["target_results"][1][
            "mhaps"
        ][1]["ad_col1"] = "this2"
        small_detected_dict_with_ad_cols["library_samples"][1]["target_results"][2][
            "mhaps"
        ][0]["ad_col1"] = "this3"
        small_detected_dict_with_ad_cols["library_samples"][2]["target_results"][0][
            "mhaps"
        ][0]["ad_col1"] = "this4"
        small_detected_dict_with_ad_cols["library_samples"][2]["target_results"][1][
            "mhaps"
        ][0]["ad_col1"] = "this1"
        small_detected_dict_with_ad_cols["library_samples"][3]["target_results"][0][
            "mhaps"
        ][0]["ad_col1"] = "this2"
        small_detected_dict_with_ad_cols["library_samples"][4]["target_results"][0][
            "mhaps"
        ][0]["ad_col1"] = "this3"
        small_detected_dict_with_ad_cols["library_samples"][4]["target_results"][0][
            "mhaps"
        ][1]["ad_col1"] = "this4"
        small_detected_dict_with_ad_cols["library_samples"][4]["target_results"][1][
            "mhaps"
        ][0]["ad_col1"] = "this4"
        small_detected_dict_with_ad_cols["library_samples"][0]["target_results"][1][
            "mhaps"
    ...
    @patch(
        "pmotools.pmo_builder.mhap_table_to_pmo.get_target_id_in_representative_mhaps"
    )
    @patch(
        "pmotools.pmo_builder.mhap_table_to_pmo.get_mhap_index_in_representative_mhaps"
    )
    @patch("pmotools.pmo_builder.mhap_table_to_pmo.build_detected_mhap_dict")
    def test_create_detected_microhaplotype_dict(
        self,
        mock_build_detected_mhap_dict,
        mock_get_mhap_index_in_representative_mhaps,
        mock_get_target_id_in_representative_mhaps,
        mock_check_additional_columns_exist,
    ):
        mock_get_target_id_in_representative_mhaps.return_value = (
            self.small_df_mhaps_target_id_values
        )
        mock_get_mhap_index_in_representative_mhaps.return_value = (
            self.small_df_mhap_id_values
        )
        ...
        masking_df = pd.DataFrame(
            {
                ...
                "masking_seq_start": ["5,92", "4"],
                "masking_seq_segment_size": ["30,12", "6"],
                "masking_replacement_size": ["30,13", "6"],
            }
        )
        mhap_table_with_masking = self.small_mhap_table.merge(masking_df, how="left")
        rep_dict_with_masking = copy.deepcopy(self.small_representative_dict)
        rep_dict_with_masking["targets"][0]["microhaplotypes"][0]["masking"] = [
            {"seq_start": 5, "seq_segment_size": 30, "replacement_size": 30},
            {"seq_start": 92, "seq_segment_size": 12, "replacement_size": 13},
        ]
        rep_dict_with_masking["targets"][0]["microhaplotypes"][1]["masking"] = [
            {"seq_start": 5, "seq_segment_size": 30, "replacement_size": 30},
            {"seq_start": 92, "seq_segment_size": 12, "replacement_size": 13},
        ]
        rep_dict_with_masking["targets"][0]["microhaplotypes"][2]["masking"] = [
            {"seq_start": 5, "seq_segment_size": 30, "replacement_size": 30},
            {"seq_start": 92, "seq_segment_size": 12, "replacement_size": 13},
        ]
    ...
    def test_mhap_table_to_pmo(
        self,
        mock_create_detected_microhaplotype_dict,
        ...
        actual = mhap_table_to_pmo(self.small_mhap_table, self.bioinformatics_run_name)
        self.assertEqual(
            actual,
            {
    ...
    def test_create_minimum_library_specimen_custom_library_sample_key(self):
        ...
        result = create_minimum_library_specimen_dict_from_mhap_table(
            detected, panel_name="panel_A", library_sample_key="custom_key"
        )
        names = [e["library_sample_name"] for e in result["library_sample_info"]]
    ...
    def test_create_minimum_library_specimen_missing_library_sample_key_raises(self):
        detected = [
            {
                "library_samples": [
    ...
    def test_create_minimum_library_specimen_all_missing_library_sample_keys_raise(
        self,
    ):
        detected = [
