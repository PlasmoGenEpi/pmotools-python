...
def get_parser_export_sequencing_info_meta_table() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="pmotools-python export_sequencing_info_meta_table",
...
def parse_args_export_sequencing_info_meta_table():
    parser = get_parser_export_sequencing_info_meta_table()
...
def export_sequencing_info_meta_table():
    ...
    # count fields
    info_df = PMOExporter.export_sequencing_info_meta_table(pmo)
