...
def get_parser_export_panel_info_meta_table() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="pmotools-python export_panel_info_meta_table",
        description="export the panel info meta table from a PMO file",
    )
...
def parse_args_export_panel_info_meta_table():
    parser = get_parser_export_panel_info_meta_table()
