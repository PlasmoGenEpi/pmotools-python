...
def get_parser_export_specimen_meta_table() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="pmotools-python export_specimen_meta_table",
        description="export the specimen meta table from a PMO file",
    )
...
def parse_args_export_specimen_meta_table():
    parser = get_parser_export_specimen_meta_table()
    return parser.parse_args()


def export_specimen_meta_table():
    args = parse_args_export_specimen_meta_table()
    ...
    # count fields
    info_df = PMOExporter.export_specimen_meta_table(pmo)
