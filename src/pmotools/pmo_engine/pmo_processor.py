...
class PMOProcessor:
    ...
    def update_specimen_meta_with_traveler_info(
        ...
        :param bed_net_usage_col: a number between 0 - 1 for rough frequency of bednet usage while traveling
        :param geo_admin1_col: the column name containing the traveled to country admin level 1 info
        :param geo_admin2_col: the column name containing the traveled to country admin level 2 info
        :param geo_admin3_col: the column name containing the traveled to country admin level 3 info
        :param lat_lon_col: the latitude and longitude column name containing the region traveled to latitude and longitude
